# PeerChat — Implementation Plan v2
...
#### [NEW] [communication_mode.dart](../lib/src/models/communication_mode.dart)
...
#### [MODIFY] [mesh_router_service.dart](../lib/src/services/mesh_router_service.dart)
- Add mode check at top of [sendMessage()](../lib/src/services/transport_service.dart#49-75):
...
- Wire retry triggers: call [_processQueue()](../lib/src/services/mesh_router_service.dart#540-590) on [onPeerConnected](../lib/src/services/route_manager.dart#233-247) and `onRouteUpdated` events
...
#### [DELETE] [simple_message_service.dart](../lib/src/services/simple_message_service.dart)
- Legacy testing service, superseded by [MeshRouterService](../lib/src/services/mesh_router_service.dart#47-670) with direct mode

#### [MODIFY] [connection_manager.dart](../lib/src/services/connection_manager.dart)
- **Peer identity persistence**: on reconnect, always merge by `peerId` (public key hash) — never create duplicate peer entries
- Add explicit guard: `mergeSessionsByPeerId()` in [handleHandshake()](../lib/src/services/connection_manager.dart#73-121) — if transport ID changes, update mapping atomically
...
#### [MODIFY] [mesh_message.dart](../lib/src/models/mesh_message.dart)
...
#### [MODIFY] [queued_message.dart](../lib/src/models/queued_message.dart)
- Add `int nextRetryTime` field
- Add `static const int maxRetries = 50`
- Add `bool get shouldDrop => attemptCount > maxRetries`
- Update [toMap()](../lib/src/models/queued_message.dart#27-38) / [fromMap()](../lib/src/models/queued_message.dart#40-52) + DB schema

#### [MODIFY] [message_queue.dart](../lib/src/services/message_queue.dart)
...
#### [MODIFY] [route_manager.dart](../lib/src/services/route_manager.dart)
...
- Fire event in [addRoute()](../lib/src/services/route_manager.dart#83-121), [handleRouteResponse()](../lib/src/services/route_manager.dart#399-427)

#### [MODIFY] [db_service.dart](../lib/src/services/db_service.dart)
...
#### [MODIFY] [mesh_router_service.dart](../lib/src/services/mesh_router_service.dart)
- In [_forwardMessageViaTransport()](../lib/src/services/mesh_router_service.dart#392-456), if no route:
...
- Track `forwardedTo` set per messageId in [DeduplicationCache](../lib/src/services/deduplication_cache.dart#4-91)
...
#### [MODIFY] [deduplication_cache.dart](../lib/src/services/deduplication_cache.dart)
...
#### [NEW] [file_transfer.dart](../lib/src/models/file_transfer.dart)
...
- `FileChunk` class: `fileId`, `chunkIndex`, [data](../.metadata) (Uint8List)
...
#### [NEW] [file_transfer_service.dart](../lib/src/services/file_transfer_service.dart)
...
#### [NEW] [file_transfer_screen.dart](../lib/src/screens/file_transfer_screen.dart)
- File picker integration
- Progress bar with chunk count
- Pause/Resume/Cancel buttons
- SHA-256 verification status

#### [MODIFY] [chat_screen.dart](../lib/src/screens/chat_screen.dart)
...
#### [NEW] [emergency_broadcast_service.dart](../lib/src/services/emergency_broadcast_service.dart)
- `broadcastMessage(content)`:
  - Create [MeshMessage](../lib/src/models/mesh_message.dart#18-250) with `destinationId = "BROADCAST_EMERGENCY"`
...
- `handleBroadcast(message)`:
  ...
  - Dedup via existing [DeduplicationCache](../lib/src/services/deduplication_cache.dart#4-91)
...
#### [NEW] [emergency_broadcast_screen.dart](../lib/src/screens/emergency_broadcast_screen.dart)
...
#### [MODIFY] [main_shell.dart](../lib/src/screens/main_shell.dart)
...
#### [MODIFY] [transport_service.dart](../lib/src/services/transport_service.dart)
- Add [onConnectionLost](../lib/src/services/connection_manager.dart#122-135) callback to abstract interface
...
- Expose via existing [RoutingStats](../lib/src/services/mesh_router_service.dart#33-46) class
...
#### [MODIFY] [file_transfer_service.dart](../lib/src/services/file_transfer_service.dart)
...
#### [MODIFY] [emergency_broadcast_service.dart](../lib/src/services/emergency_broadcast_service.dart)
...
#### [MODIFY] [discovery_service.dart](../lib/src/services/discovery_service.dart)
...
#### [MODIFY] [app_state.dart](../lib/src/app_state.dart)
- Request battery optimization exemption on first launch (prompt user with explanation dialog)

#### [NEW] [foreground_service.dart](../lib/src/services/foreground_service.dart)
...
#### [MODIFY] [wifi_transport.dart](../lib/src/services/wifi_transport.dart)
